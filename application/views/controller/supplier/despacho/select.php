<div class="span-24">
    <br><br>
    <div class="title">Seleccionar Despacho Para Modificar</div>
    <?php if($despacho): ?>
    <div class="span-24"><br>
        <a href="<?php echo URL::site('supplier/despacho/create');?>">Crear Despacho</a><br/><br/>
            <table id="tblPedidos">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach($despacho as $desp): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo URL::site('supplier/despacho/create/'.$desp["ID_DESPACHO"]); ?>">
