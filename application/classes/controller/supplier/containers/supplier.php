...
class Controller_Supplier_Containers_Supplier extends Controller_Template {
    
    public $template = 'controller/supplier/containers/supplier';
	...
	public function before()
	{
		...
		parent::before();
            ...
            if(!Session::instance()->get('treasure_usuario', FALSE) OR Session::instance()->get('treasure_usuario', FALSE)=="" OR $user->ID_PERFIL!=5)
            {
                HTTP::redirect('login');
            }
