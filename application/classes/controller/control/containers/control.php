...
class Controller_Control_Containers_Control extends Controller_Template {
    
    public $template = 'controller/control/containers/control';
	...
	public function before()
	{
		...
		parent::before();
            ...
            if(!Session::instance()->get('treasure_usuario', FALSE) OR Session::instance()->get('treasure_usuario', FALSE)=="" OR $user->ID_PERFIL!=4)
            {
                HTTP::redirect('login');
            }
