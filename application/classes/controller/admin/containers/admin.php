...
class Controller_Admin_Containers_Admin extends Controller_Template {
    
    public $template = 'controller/admin/containers/admin';
	...
	public function before()
	{
		...
		parent::before();
            ...
            if(!Session::instance()->get('treasure_usuario', FALSE) OR Session::instance()->get('treasure_usuario', FALSE)=="" OR $user->ID_PERFIL!=1)
            {
                HTTP::redirect('login');
            }
