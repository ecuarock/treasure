        ...
        $('#select_estado').bind('change',function(){
            ...
            if($('#select_estado').val()!='')
            {
                ...
                $('#select_anios_content').load(
                    document_root+"admin/reporte/load_departamentos_anios",
                    {
                        sent_estado: $('#select_estado').val(),
                        sent_departamento: $('#select_departamento').val()
                    },  
                    function() {
                        hide_ajax_loader()
                               ...
                               if($('#select_anios').val()!='')
                                {
                                    ...
                                    $('#select_meses_content').load(
                                          document_root+"admin/reporte/load_departamento_meses",
                                            {
                                                sent_estado: $('#select_estado').val(),
                                            ...
                                            function()
                                            {
                                                ...
                                                $('#select_meses').bind('change',function(){
                                                    ...
                                                    if($('#select_meses').val()!='')
                                                    {
                                                        ...
                                                        $('#tblContainer').empty();
                                                        $('#tblContainer').load(
                                                        document_root+"admin/reporte/load_departamento_table",
                                                        {
                                                            sent_estado: $('#select_estado').val(),
                                                            sent_anio: $('#select_anios').val(),
...
//                                                                 });
        ...
        $('#select_departamento').bind('change',function(){
            show_ajax_loader();
            if($('#select_departamento').val()!='')
            {
                $('#estado_content').css('display','none');
                $("#select_estado option[value='']").attr("selected",true);
                $('#anios_content').css('display','none');
                $('#select_anios_content').empty();
                $('#meses_content').css('display','none');
                $('#select_meses_content').empty();
                $('#tblContainer').css('display','none');
                $('#tblContainer').empty();
                $('#estado_content').css('display','block');
                $("#select_estado option[value='']").attr("selected",true);  
                hide_ajax_loader();
            }
            else
